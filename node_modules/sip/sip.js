...
***********************************************************************************
 Description :  As a part of the US211553(Evaluation of sip.js by implementing
                a B2BUA),the SIP stack has been modified to include logic of sending
                responses using SDP and expires headers. New API's has been added
...
/* US211553-Start : Evaluation of sip.js by implementing a B2BUA
 * Added new functionality of sending response with expires
 * and with SDP. This functionality is missing in sip.js
 */
function makeResponseWithExpires(rq, status, reason) {
...
function makeResponseWithSDP(rq, status, reason) {
    return {
        status: status,
        reason: reason || '',
        version: rq.version,
...
exports.makeResponseWithSDP = makeResponseWithSDP;
exports.makeResponseWithExpires = makeResponseWithExpires;
/*US211553-End */
